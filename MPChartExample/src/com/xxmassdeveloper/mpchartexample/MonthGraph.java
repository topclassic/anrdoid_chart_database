 ...
 */
public class MonthGraph extends DemoBase {
	float watt;
	float unit;
	float bath;
	...
	private class ReadData extends AsyncTask<String, Void, Boolean>{
		...
		private ProgressDialog dialog = new ProgressDialog(MonthGraph.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if(result == false){
				Toast.makeText(MonthGraph.this, error, Toast.LENGTH_LONG).show();
			}
			else{	
    ...
    private LineData generateDataLine(int cnt) {
    	...
    	LineDataSet d1;
          ...
          ArrayList<Entry> e3 = new ArrayList<Entry>();
              ...
              e1.add(new Entry(watt, 25)); 
              e1.add(new Entry(watt, 26)); 
              e1.add(new Entry(watt, 27)); 
              e1.add(new Entry(watt, 28)); 
              e1.add(new Entry(watt, 29)); 
              e1.add(new Entry(watt, 30));
              e1.add(new Entry(watt, 31));
              ...
              e2.add(new Entry(unit, 25)); 
              e2.add(new Entry(unit, 26)); 
              e2.add(new Entry(unit, 27)); 
              e2.add(new Entry(unit, 28)); 
              e2.add(new Entry(unit, 29)); 
              e2.add(new Entry(unit, 30)); 
              e2.add(new Entry(unit, 31));  
              ...
              e3.add(new Entry(bath, 25)); 
              e3.add(new Entry(bath, 26)); 
              e3.add(new Entry(bath, 27)); 
              e3.add(new Entry(bath, 28)); 
              e3.add(new Entry(bath, 29)); 
              e3.add(new Entry(bath, 30));
              e3.add(new Entry(bath, 31));
